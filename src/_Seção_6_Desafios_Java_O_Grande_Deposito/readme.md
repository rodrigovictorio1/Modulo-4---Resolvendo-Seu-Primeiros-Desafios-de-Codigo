...
## Entrada
O programa deve utilizar o <font color="pink">**Scanner**</font> para receber os valores de depósito digitados pelo cliente. Os valores podem ser decimais, representando valores em reais.
...
| ENTRADA | SAÍDA                                                            |
|---------|------------------------------------------------------------------|
| 500.50  | Deposito realizado com sucesso! Saldo atual: R$ 500.50 7346.64   |
